...
<div class="shortcut-container">
    <a href="#campus-media" class="shortcut btn">Campus Media</a>
    <a href="#public-relation" class="shortcut btn">Public Relation</a>
    <a href="#data-infographic-news" class="shortcut btn">Data Infographic News</a>
    <a href="#public-welfare" class="shortcut btn">Public Welfare</a>
    <a href="#post" class="shortcut btn">Post</a>
    <a href="#journalistic-practice" class="shortcut btn">Journalistic Practice</a>
    <a href="#course-paper" class="shortcut btn">Academic Paper</a>
    <a href="#conference" class="shortcut btn">Conference</a>
    <a href="#research-promotion" class="shortcut btn">Research Promotion</a>
</div>
